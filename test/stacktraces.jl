...
let
    ...
    line_numbers = @__LINE__ - [3]

    @test try_stacktrace()[1] == StackFrame(:try_stacktrace, @__FILE__, line_numbers[1])
    ...
    line_numbers = @__LINE__ - [6]

    @test try_stacktrace_bad()[1] == StackFrame(:try_stacktrace_bad, @__FILE__, line_numbers[1])
end
